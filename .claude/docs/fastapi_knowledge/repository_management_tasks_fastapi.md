...
- Source URL: https://fastapi.tiangolo.com/management-tasks
- Page Title: Repository Management Tasks - FastAPI
- Semantic Filename: repository_management_tasks_fastapi.md
- Ollama Model: llama3.2:3b
- Export Mode: Smart Deep Crawl
- Statistics:
  - Status: Success
  - Content Length: 14,066 characters
---
...
# Repository Management Tasks[¶](https://fastapi.tiangolo.com/management-tasks/#repository-management-tasks)
...
## Be Nice[¶](https://fastapi.tiangolo.com/management-tasks/#be-nice)
First of all, be nice. 😊
You probably are super nice if you were added to the team, but it's worth mentioning it. 🤓
### When Things are Difficult[¶](https://fastapi.tiangolo.com/management-tasks/#when-things-are-difficult)
...
## Edit PR Titles[¶](https://fastapi.tiangolo.com/management-tasks/#edit-pr-titles)
...
## Add Labels to PRs[¶](https://fastapi.tiangolo.com/management-tasks/#add-labels-to-prs)
...
## Add Labels to Translation PRs[¶](https://fastapi.tiangolo.com/management-tasks/#add-labels-to-translation-prs)
...
## Merge Translation PRs[¶](https://fastapi.tiangolo.com/management-tasks/#merge-translation-prs)
...
consejo
Esto es un consejo.
## First Translation PR[¶](https://fastapi.tiangolo.com/management-tasks/#first-translation-pr)
...
## Review PRs[¶](https://fastapi.tiangolo.com/management-tasks/#review-prs)
...
## FastAPI People PRs[¶](https://fastapi.tiangolo.com/management-tasks/#fastapi-people-prs)
...
## External Links PRs[¶](https://fastapi.tiangolo.com/management-tasks/#external-links-prs)
...
## Dependabot PRs[¶](https://fastapi.tiangolo.com/management-tasks/#dependabot-prs)
...
## Mark GitHub Discussions Answers[¶](https://fastapi.tiangolo.com/management-tasks/#mark-github-discussions-answers)
