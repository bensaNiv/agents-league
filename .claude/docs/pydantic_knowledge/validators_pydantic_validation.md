...
- Source URL: https://docs.pydantic.dev/latest/concepts/validators
- Page Title: Validators - Pydantic Validation
- Semantic Filename: validators_pydantic_validation.md
- Ollama Model: llama3.2:3b
- Export Mode: Smart Deep Crawl
- Statistics:
  - Status: Success
  - Content Length: 31,123 characters
---
...
classModel(BaseModel):
    ...
    @field_validator('number', mode='after')  [](https://docs.pydantic.dev/latest/concepts/validators/#__code_1_annotation_1)
    @classmethod
    defis_even(cls, value: int) -> int:
        if value % 2 == 1:
            raise ValueError(f'{value} is not an even number')
        return value  [](https://docs.pydantic.dev/latest/concepts/validators/#__code_1_annotation_2)
...
classModel(BaseModel):
    ...
    @field_validator('number', mode='after')  [](https://docs.pydantic.dev/latest/concepts/validators/#__code_3_annotation_1)
    @classmethod
...
defensure_list(value: Any) -> Any:  [](https://docs.pydantic.dev/latest/concepts/validators/#__code_4_annotation_1)
...
classModel(BaseModel):
    ...
    @classmethod
    defensure_list(cls, value: Any) -> Any:  [](https://docs.pydantic.dev/latest/concepts/validators/#__code_5_annotation_1)
        if not isinstance(value, list):  [](https://docs.pydantic.dev/latest/concepts/validators/#__code_5_annotation_2)
            return [value]
        else:
            return value
...
try:
    ...
    print(err)  [](https://docs.pydantic.dev/latest/concepts/validators/#__code_5_annotation_3)
"""
    1 validation error for Model
    numbers.0
      Input should be a valid integer, unable to parse string as an integer [type=int_parsing, input_value='str', input_type=str]
...
print(Model(number=4))
#> number=8
print(Model(number='invalid'))  [](https://docs.pydantic.dev/latest/concepts/validators/#__code_7_annotation_1)
#> number='invalid'
...
classUserModel(BaseModel):
    ...
    @classmethod
    defcheck_card_number_not_present(cls, data: Any) -> Any:  [](https://docs.pydantic.dev/latest/concepts/validators/#__code_13_annotation_1)
