...
- Source URL: https://docs.pydantic.dev/latest/api/fields
...
- Statistics:
  - Status: Success
  - Content Length: 67,014 characters
---
...
```
| ```
defasdict(self) -> _FieldInfoAsDict:
"""Return a dictionary representation of the `FieldInfo` instance.
...
```
| ```
def__init__(self, default: Any = PydanticUndefined, *, default_factory: Callable[[], Any] | None = None) -> None:
    if default is Ellipsis:
        self.default = PydanticUndefined
    else:
        self.default = default
...
```
| ```
def__set_name__(self, cls: type[Any], name: str) -> None:
"""Preserve `__set_name__` protocol defined in https://peps.python.org/pep-0487."""
