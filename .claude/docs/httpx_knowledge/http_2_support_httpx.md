...
- Source URL: https://www.python-httpx.org/http2
- Page Title: HTTP/2 Support - HTTPX
- Semantic Filename: http_2_support_httpx.md
...
For a comprehensive guide to HTTP/2 you may want to check out "
## Enabling HTTP/2
