...
- Source URL: https://www.python-httpx.org/advanced/transports
- Page Title: Transports - HTTPX
- Semantic Filename: transports_httpx.md
- Ollama Model: llama3.2:3b
- Export Mode: Smart Deep Crawl
- Statistics:
  - Status: Success
  - Content Length: 13,784 characters
---
...
Connection retries are also available via this interface. Requests will be retried the given number of times in case an `httpx.ConnectError` or an `httpx.ConnectTimeout` occurs, allowing smoother operation under flaky networks. If you need other forms of retry behaviors, such as handling read/write errors or reacting to `503 Service Unavailable`, consider general-purpose tools such as 
```
>>> importhttpx
...
For more advanced use-cases you might want to take a look at either 
## Mounting transports
