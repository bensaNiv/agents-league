...
- Source URL: https://docs.astral.sh/uv/reference/environment
- Page Title: Environment variables | uv
- Semantic Filename: environment_variables_uv.md
- Ollama Model: llama3.2:3b
- Export Mode: Smart Deep Crawl
- Statistics:
  - Status: Success
  - Content Length: 42,390 characters
---
...
### [`UV_BREAK_SYSTEM_PACKAGES`](https://docs.astral.sh/uv/reference/environment/#uv_break_system_packages)
added in `0.1.32`
...
### [`UV_BUILD_CONSTRAINT`](https://docs.astral.sh/uv/reference/environment/#uv_build_constraint)
added in `0.2.34`
...
### [`UV_COMPILE_BYTECODE`](https://docs.astral.sh/uv/reference/environment/#uv_compile_bytecode)
added in `0.3.3`
...
### [`UV_COMPILE_BYTECODE_TIMEOUT`](https://docs.astral.sh/uv/reference/environment/#uv_compile_bytecode_timeout)
added in `0.7.22`
Timeout (in seconds) for bytecode compilation.
### [`UV_CONCURRENT_BUILDS`](https://docs.astral.sh/uv/reference/environment/#uv_concurrent_builds)
added in `0.1.43`
Sets the maximum number of source distributions that uv will build concurrently at any given time.
### [`UV_CONCURRENT_DOWNLOADS`](https://docs.astral.sh/uv/reference/environment/#uv_concurrent_downloads)
added in `0.1.43`
Sets the maximum number of in-flight concurrent downloads that uv will perform at any given time.
### [`UV_CONCURRENT_INSTALLS`](https://docs.astral.sh/uv/reference/environment/#uv_concurrent_installs)
added in `0.1.45`
...
### [`UV_CUSTOM_COMPILE_COMMAND`](https://docs.astral.sh/uv/reference/environment/#uv_custom_compile_command)
added in `0.1.23`
...
### [`UV_DEV`](https://docs.astral.sh/uv/reference/environment/#uv_dev)
added in `0.8.7`
Equivalent to the `--dev` command-line argument. If set, uv will include development dependencies.
### [`UV_DOWNLOAD_URL`](https://docs.astral.sh/uv/reference/environment/#uv_download_url)
added in `0.8.4`
...
### [`UV_ENV_FILE`](https://docs.astral.sh/uv/reference/environment/#uv_env_file)
added in `0.4.30`
`.env` files from which to load environment variables when executing `uv run` commands.
### [`UV_EXCLUDE`](https://docs.astral.sh/uv/reference/environment/#uv_exclude)
added in `0.9.8`
...
### [`UV_EXCLUDE_NEWER`](https://docs.astral.sh/uv/reference/environment/#uv_exclude_newer)
added in `0.2.12`
...
### [`UV_EXTRA_INDEX_URL`](https://docs.astral.sh/uv/reference/environment/#uv_extra_index_url)
added in `0.1.3`
...
### [`UV_FIND_LINKS`](https://docs.astral.sh/uv/reference/environment/#uv_find_links)
added in `0.4.19`
...
### [`UV_FORK_STRATEGY`](https://docs.astral.sh/uv/reference/environment/#uv_fork_strategy)
added in `0.5.9`
Equivalent to the `--fork-strategy` argument. Controls version selection during universal resolution.
### [`UV_FROZEN`](https://docs.astral.sh/uv/reference/environment/#uv_frozen)
added in `0.4.25`
Equivalent to the `--frozen` command-line argument. If set, uv will run without updating the `uv.lock` file.
### [`UV_GITHUB_TOKEN`](https://docs.astral.sh/uv/reference/environment/#uv_github_token)
added in `0.4.10`
Equivalent to the `--token` argument for self update. A GitHub token for authentication.
### [`UV_GIT_LFS`](https://docs.astral.sh/uv/reference/environment/#uv_git_lfs)
added in `0.5.19`
Enables fetching files stored in Git LFS when installing a package from a Git repository.
### [`UV_HIDE_BUILD_OUTPUT`](https://docs.astral.sh/uv/reference/environment/#uv_hide_build_output)
added in `0.9.15`
Suppress output from the build backend when building source distributions, even in the event of build failures.
### [`UV_HTTP_RETRIES`](https://docs.astral.sh/uv/reference/environment/#uv_http_retries)
added in `0.7.21`
The number of retries for HTTP requests. (default: 3)
### [`UV_HTTP_TIMEOUT`](https://docs.astral.sh/uv/reference/environment/#uv_http_timeout)
added in `0.1.7`
Timeout (in seconds) for HTTP requests. (default: 30 s)
### [`UV_INDEX`](https://docs.astral.sh/uv/reference/environment/#uv_index)
added in `0.4.23`
...
### [`UV_INDEX_STRATEGY`](https://docs.astral.sh/uv/reference/environment/#uv_index_strategy)
added in `0.1.29`
...
### [`UV_INDEX_URL`](https://docs.astral.sh/uv/reference/environment/#uv_index_url)
added in `0.0.5`
...
### [`UV_INDEX_{name}_PASSWORD`](https://docs.astral.sh/uv/reference/environment/#uv_index_name_password)
added in `0.4.23`
...
### [`UV_INDEX_{name}_USERNAME`](https://docs.astral.sh/uv/reference/environment/#uv_index_name_username)
added in `0.4.23`
...
### [`UV_INIT_BUILD_BACKEND`](https://docs.astral.sh/uv/reference/environment/#uv_init_build_backend)
added in `0.8.2`
Equivalent to the `--build-backend` argument for `uv init`. Determines the default backend to use when creating a new project.
### [`UV_INSECURE_HOST`](https://docs.astral.sh/uv/reference/environment/#uv_insecure_host)
added in `0.3.5`
Equivalent to the `--allow-insecure-host` argument.
### [`UV_INSECURE_NO_ZIP_VALIDATION`](https://docs.astral.sh/uv/reference/environment/#uv_insecure_no_zip_validation)
added in `0.8.6`
...
### [`UV_INSTALLER_GHE_BASE_URL`](https://docs.astral.sh/uv/reference/environment/#uv_installer_ghe_base_url)
added in `0.5.0`
...
### [`UV_INSTALLER_GITHUB_BASE_URL`](https://docs.astral.sh/uv/reference/environment/#uv_installer_github_base_url)
added in `0.5.0`
...
### [`UV_LINK_MODE`](https://docs.astral.sh/uv/reference/environment/#uv_link_mode)
added in `0.1.40`
Equivalent to the `--link-mode` command-line argument. If set, uv will use this as a link mode.
### [`UV_LOCKED`](https://docs.astral.sh/uv/reference/environment/#uv_locked)
added in `0.4.25`
Equivalent to the `--locked` command-line argument. If set, uv will assert that the `uv.lock` remains unchanged.
### [`UV_LOCK_TIMEOUT`](https://docs.astral.sh/uv/reference/environment/#uv_lock_timeout)
added in `0.9.4`
The time in seconds uv waits for a file lock to become available.
Defaults to 300s (5 min).
### [`UV_LOG_CONTEXT`](https://docs.astral.sh/uv/reference/environment/#uv_log_context)
added in `0.6.4`
Add additional context and structure to log messages.
If logging is not enabled, e.g., with `RUST_LOG` or `-v`, this has no effect.
### [`UV_MANAGED_PYTHON`](https://docs.astral.sh/uv/reference/environment/#uv_managed_python)
added in `0.6.8`
Require use of uv-managed Python versions.
### [`UV_NATIVE_TLS`](https://docs.astral.sh/uv/reference/environment/#uv_native_tls)
added in `0.1.19`
...
### [`UV_NO_BINARY`](https://docs.astral.sh/uv/reference/environment/#uv_no_binary)
added in `0.5.30`
...
### [`UV_NO_BINARY_PACKAGE`](https://docs.astral.sh/uv/reference/environment/#uv_no_binary_package)
added in `0.5.30`
...
### [`UV_NO_BUILD_ISOLATION`](https://docs.astral.sh/uv/reference/environment/#uv_no_build_isolation)
added in `0.1.40`
...
### [`UV_NO_BUILD_PACKAGE`](https://docs.astral.sh/uv/reference/environment/#uv_no_build_package)
added in `0.6.5`
...
### [`UV_NO_CACHE`](https://docs.astral.sh/uv/reference/environment/#uv_no_cache)
added in `0.1.2`
...
### [`UV_NO_DEV`](https://docs.astral.sh/uv/reference/environment/#uv_no_dev)
added in `0.8.7`
...
### [`UV_NO_ENV_FILE`](https://docs.astral.sh/uv/reference/environment/#uv_no_env_file)
added in `0.4.30`
...
### [`UV_NO_HF_TOKEN`](https://docs.astral.sh/uv/reference/environment/#uv_no_hf_token)
added in `0.8.1`
...
### [`UV_NO_MANAGED_PYTHON`](https://docs.astral.sh/uv/reference/environment/#uv_no_managed_python)
added in `0.6.8`
...
### [`UV_NO_PROGRESS`](https://docs.astral.sh/uv/reference/environment/#uv_no_progress)
added in `0.2.28`
Equivalent to the `--no-progress` command-line argument. Disables all progress output. For example, spinners and progress bars.
### [`UV_NO_SOURCES`](https://docs.astral.sh/uv/reference/environment/#uv_no_sources)
added in `0.9.8`
...
### [`UV_NO_SYNC`](https://docs.astral.sh/uv/reference/environment/#uv_no_sync)
added in `0.4.18`
Equivalent to the `--no-sync` command-line argument. If set, uv will skip updating the environment.
### [`UV_NO_VERIFY_HASHES`](https://docs.astral.sh/uv/reference/environment/#uv_no_verify_hashes)
added in `0.5.3`
Equivalent to the `--no-verify-hashes` argument. Disables hash verification for `requirements.txt` files.
### [`UV_NO_WRAP`](https://docs.astral.sh/uv/reference/environment/#uv_no_wrap)
added in `0.0.5`
Use to disable line wrapping for diagnostics.
### [`UV_OFFLINE`](https://docs.astral.sh/uv/reference/environment/#uv_offline)
added in `0.5.9`
Equivalent to the `--offline` command-line argument. If set, uv will disable network access.
### [`UV_OVERRIDE`](https://docs.astral.sh/uv/reference/environment/#uv_override)
added in `0.2.22`
...
### [`UV_PRERELEASE`](https://docs.astral.sh/uv/reference/environment/#uv_prerelease)
added in `0.1.16`
...
### [`UV_PREVIEW`](https://docs.astral.sh/uv/reference/environment/#uv_preview)
added in `0.1.37`
Equivalent to the `--preview` argument. Enables preview mode.
### [`UV_PREVIEW_FEATURES`](https://docs.astral.sh/uv/reference/environment/#uv_preview_features)
added in `0.8.4`
Equivalent to the `--preview-features` argument. Enables specific preview features.
### [`UV_PROJECT`](https://docs.astral.sh/uv/reference/environment/#uv_project)
added in `0.4.4`
...
### [`UV_PUBLISH_CHECK_URL`](https://docs.astral.sh/uv/reference/environment/#uv_publish_check_url)
added in `0.4.30`
Don't upload a file if it already exists on the index. The value is the URL of the index.
### [`UV_PUBLISH_INDEX`](https://docs.astral.sh/uv/reference/environment/#uv_publish_index)
added in `0.5.8`
...
### [`UV_PUBLISH_NO_ATTESTATIONS`](https://docs.astral.sh/uv/reference/environment/#uv_publish_no_attestations)
added in `0.9.12`
...
### [`UV_PUBLISH_PASSWORD`](https://docs.astral.sh/uv/reference/environment/#uv_publish_password)
added in `0.4.16`
Equivalent to the `--password` command-line argument in `uv publish`. If set, uv will use this password for publishing.
### [`UV_PUBLISH_TOKEN`](https://docs.astral.sh/uv/reference/environment/#uv_publish_token)
added in `0.4.16`
...
### [`UV_PUBLISH_URL`](https://docs.astral.sh/uv/reference/environment/#uv_publish_url)
added in `0.4.16`
Equivalent to the `--publish-url` command-line argument. The URL of the upload endpoint of the index to use with `uv publish`.
### [`UV_PUBLISH_USERNAME`](https://docs.astral.sh/uv/reference/environment/#uv_publish_username)
added in `0.4.16`
...
### [`UV_PYTHON_CPYTHON_BUILD`](https://docs.astral.sh/uv/reference/environment/#uv_python_cpython_build)
added in `0.8.14`
Pin managed CPython versions to a specific build version.
For CPython, this should be the build date (e.g., "20250814").
### [`UV_PYTHON_DOWNLOADS`](https://docs.astral.sh/uv/reference/environment/#uv_python_downloads)
added in `0.3.2`
...
### [`UV_PYTHON_GRAALPY_BUILD`](https://docs.astral.sh/uv/reference/environment/#uv_python_graalpy_build)
added in `0.8.14`
Pin managed GraalPy versions to a specific build version.
For GraalPy, this should be the GraalPy version (e.g., "24.2.2").
### [`UV_PYTHON_INSTALL_BIN`](https://docs.astral.sh/uv/reference/environment/#uv_python_install_bin)
added in `0.8.0`
...
### [`UV_PYTHON_INSTALL_REGISTRY`](https://docs.astral.sh/uv/reference/environment/#uv_python_install_registry)
added in `0.8.0`
Whether to install the Python executable into the Windows registry.
### [`UV_PYTHON_PREFERENCE`](https://docs.astral.sh/uv/reference/environment/#uv_python_preference)
added in `0.3.2`
Whether uv should prefer system or managed Python versions.
### [`UV_PYTHON_PYODIDE_BUILD`](https://docs.astral.sh/uv/reference/environment/#uv_python_pyodide_build)
added in `0.8.14`
Pin managed Pyodide versions to a specific build version.
For Pyodide, this should be the Pyodide version (e.g., "0.28.1").
### [`UV_PYTHON_PYPY_BUILD`](https://docs.astral.sh/uv/reference/environment/#uv_python_pypy_build)
added in `0.8.14`
Pin managed PyPy versions to a specific build version.
For PyPy, this should be the PyPy version (e.g., "7.3.20").
### [`UV_REQUEST_TIMEOUT`](https://docs.astral.sh/uv/reference/environment/#uv_request_timeout)
added in `0.1.6`
Timeout (in seconds) for HTTP requests. Equivalent to `UV_HTTP_TIMEOUT`.
### [`UV_REQUIRE_HASHES`](https://docs.astral.sh/uv/reference/environment/#uv_require_hashes)
added in `0.1.34`
...
### [`UV_S3_ENDPOINT_URL`](https://docs.astral.sh/uv/reference/environment/#uv_s3_endpoint_url)
added in `0.8.21`
...
### [`UV_SKIP_WHEEL_FILENAME_CHECK`](https://docs.astral.sh/uv/reference/environment/#uv_skip_wheel_filename_check)
added in `0.8.23`
...
### [`UV_STACK_SIZE`](https://docs.astral.sh/uv/reference/environment/#uv_stack_size)
added in `0.0.5`
...
### [`UV_TEST_NO_HTTP_RETRY_DELAY`](https://docs.astral.sh/uv/reference/environment/#uv_test_no_http_retry_delay)
added in `0.7.21`
...
### [`UV_TORCH_BACKEND`](https://docs.astral.sh/uv/reference/environment/#uv_torch_backend)
added in `0.6.9`
...
### [`UV_UPLOAD_HTTP_TIMEOUT`](https://docs.astral.sh/uv/reference/environment/#uv_upload_http_timeout)
added in `0.9.1`
Timeout (in seconds) for only upload HTTP requests. (default: 900 s)
### [`UV_VENV_CLEAR`](https://docs.astral.sh/uv/reference/environment/#uv_venv_clear)
added in `0.8.0`
Equivalent to the `--clear` command-line argument. If set, uv will remove any existing files or directories at the target path.
### [`UV_VENV_SEED`](https://docs.astral.sh/uv/reference/environment/#uv_venv_seed)
added in `0.5.21`
...
## [Externally defined variables](https://docs.astral.sh/uv/reference/environment/#externally-defined-variables)
uv also reads the following externally defined environment variables:
### [`ALL_PROXY`](https://docs.astral.sh/uv/reference/environment/#all_proxy)
added in `0.1.38`
General proxy for all network requests.
### [`ANDROID_API_LEVEL`](https://docs.astral.sh/uv/reference/environment/#android_api_level)
added in `0.8.16`
...
### [`AWS_ACCESS_KEY_ID`](https://docs.astral.sh/uv/reference/environment/#aws_access_key_id)
added in `0.8.21`
The AWS access key ID to use when signing S3 requests.
### [`AWS_CONFIG_FILE`](https://docs.astral.sh/uv/reference/environment/#aws_config_file)
added in `0.8.21`
The AWS config file to use when signing S3 requests.
### [`AWS_DEFAULT_REGION`](https://docs.astral.sh/uv/reference/environment/#aws_default_region)
added in `0.8.21`
The default AWS region to use when signing S3 requests, if `AWS_REGION` is not set.
### [`AWS_PROFILE`](https://docs.astral.sh/uv/reference/environment/#aws_profile)
added in `0.8.21`
The AWS profile to use when signing S3 requests.
### [`AWS_REGION`](https://docs.astral.sh/uv/reference/environment/#aws_region)
added in `0.8.21`
The AWS region to use when signing S3 requests.
### [`AWS_SECRET_ACCESS_KEY`](https://docs.astral.sh/uv/reference/environment/#aws_secret_access_key)
added in `0.8.21`
The AWS secret access key to use when signing S3 requests.
### [`AWS_SESSION_TOKEN`](https://docs.astral.sh/uv/reference/environment/#aws_session_token)
added in `0.8.21`
The AWS session token to use when signing S3 requests.
### [`AWS_SHARED_CREDENTIALS_FILE`](https://docs.astral.sh/uv/reference/environment/#aws_shared_credentials_file)
added in `0.8.21`
The AWS shared credentials file to use when signing S3 requests.
### [`BASH_VERSION`](https://docs.astral.sh/uv/reference/environment/#bash_version)
added in `0.1.28`
Used to detect Bash shell usage.
### [`CLICOLOR_FORCE`](https://docs.astral.sh/uv/reference/environment/#clicolor_force)
added in `0.1.32`
...
### [`CONDA_DEFAULT_ENV`](https://docs.astral.sh/uv/reference/environment/#conda_default_env)
added in `0.5.0`
...
### [`DEPENDABOT`](https://docs.astral.sh/uv/reference/environment/#dependabot)
added in `0.9.11`
Used to determine if we're running in Dependabot.
### [`FISH_VERSION`](https://docs.astral.sh/uv/reference/environment/#fish_version)
added in `0.1.28`
Used to detect Fish shell usage.
### [`FORCE_COLOR`](https://docs.astral.sh/uv/reference/environment/#force_color)
added in `0.2.7`
Forces colored output regardless of terminal support.
See 
### [`GITHUB_ACTIONS`](https://docs.astral.sh/uv/reference/environment/#github_actions)
added in `0.4.16`
...
### [`GITLAB_CI`](https://docs.astral.sh/uv/reference/environment/#gitlab_ci)
added in `0.8.18`
Indicates that the current process is running in GitLab CI.
`uv publish` may attempt trusted publishing flows when set to `true`.
### [`HF_TOKEN`](https://docs.astral.sh/uv/reference/environment/#hf_token)
added in `0.8.1`
...
### [`HOME`](https://docs.astral.sh/uv/reference/environment/#home)
added in `0.0.5`
The standard `HOME` env var.
### [`HTTPS_PROXY`](https://docs.astral.sh/uv/reference/environment/#https_proxy)
added in `0.1.38`
Proxy for HTTPS requests.
### [`HTTP_PROXY`](https://docs.astral.sh/uv/reference/environment/#http_proxy)
added in `0.1.38`
Proxy for HTTP requests.
### [`HTTP_TIMEOUT`](https://docs.astral.sh/uv/reference/environment/#http_timeout)
added in `0.1.7`
Timeout (in seconds) for HTTP requests. Equivalent to `UV_HTTP_TIMEOUT`.
### [`IPHONEOS_DEPLOYMENT_TARGET`](https://docs.astral.sh/uv/reference/environment/#iphoneos_deployment_target)
added in `0.8.16`
...
Defaults to `13.0`.
### [`JPY_SESSION_NAME`](https://docs.astral.sh/uv/reference/environment/#jpy_session_name)
added in `0.2.6`
Used to detect when running inside a Jupyter notebook.
### [`KSH_VERSION`](https://docs.astral.sh/uv/reference/environment/#ksh_version)
added in `0.2.33`
Used to detect Ksh shell usage.
### [`LOCALAPPDATA`](https://docs.astral.sh/uv/reference/environment/#localappdata)
added in `0.3.3`
Used to look for Microsoft Store Pythons installations.
### [`MACOSX_DEPLOYMENT_TARGET`](https://docs.astral.sh/uv/reference/environment/#macosx_deployment_target)
added in `0.1.42`
...
### [`NETRC`](https://docs.astral.sh/uv/reference/environment/#netrc)
added in `0.1.16`
Use to set the .netrc file location.
### [`NO_COLOR`](https://docs.astral.sh/uv/reference/environment/#no_color)
added in `0.2.7`
Disables colored output (takes precedence over `FORCE_COLOR`).
See 
### [`NO_PROXY`](https://docs.astral.sh/uv/reference/environment/#no_proxy)
added in `0.1.38`
Comma-separated list of hostnames (e.g., `example.com`) and/or patterns (e.g., `192.168.1.0/24`) that should bypass the proxy.
### [`NU_VERSION`](https://docs.astral.sh/uv/reference/environment/#nu_version)
added in `0.1.16`
Used to detect `NuShell` usage.
### [`PAGER`](https://docs.astral.sh/uv/reference/environment/#pager)
added in `0.4.18`
...
### [`PROMPT`](https://docs.astral.sh/uv/reference/environment/#prompt)
added in `0.1.16`
Used to detect the use of the Windows Command Prompt (as opposed to PowerShell).
### [`PWD`](https://docs.astral.sh/uv/reference/environment/#pwd)
added in `0.0.5`
The standard `PWD` posix env var.
### [`PYC_INVALIDATION_MODE`](https://docs.astral.sh/uv/reference/environment/#pyc_invalidation_mode)
added in `0.1.7`
...
### [`PYX_API_KEY`](https://docs.astral.sh/uv/reference/environment/#pyx_api_key)
added in `0.8.15`
The pyx API key (e.g., `sk-pyx-...`).
### [`PYX_API_URL`](https://docs.astral.sh/uv/reference/environment/#pyx_api_url)
added in `0.8.15`
The URL of the pyx Simple API server.
### [`PYX_AUTH_TOKEN`](https://docs.astral.sh/uv/reference/environment/#pyx_auth_token)
added in `0.8.15`
The pyx authentication token (e.g., `eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9...`), as output by `uv auth token`.
### [`PYX_CDN_DOMAIN`](https://docs.astral.sh/uv/reference/environment/#pyx_cdn_domain)
added in `0.8.15`
...
### [`RUST_BACKTRACE`](https://docs.astral.sh/uv/reference/environment/#rust_backtrace)
added in `0.7.22`
...
See the 
### [`RUST_LOG`](https://docs.astral.sh/uv/reference/environment/#rust_log)
added in `0.0.5`
...
See the 
### [`RUST_MIN_STACK`](https://docs.astral.sh/uv/reference/environment/#rust_min_stack)
added in `0.5.19`
Use to set the stack size used by uv.
The value is in bytes, and if both `UV_STACK_SIZE` are `RUST_MIN_STACK` unset, uv uses a 4MB (4194304) stack. `UV_STACK_SIZE` takes precedence over `RUST_MIN_STACK`.
...
### [`SHELL`](https://docs.astral.sh/uv/reference/environment/#shell)
added in `0.1.16`
...
Takes precedence over `UV_NATIVE_TLS` when set.
### [`SSL_CLIENT_CERT`](https://docs.astral.sh/uv/reference/environment/#ssl_client_cert)
added in `0.2.11`
...
### [`TRACING_DURATIONS_FILE`](https://docs.astral.sh/uv/reference/environment/#tracing_durations_file)
added in `0.0.5`
...
See 
### [`VIRTUAL_ENV`](https://docs.astral.sh/uv/reference/environment/#virtual_env)
added in `0.0.5`
Used to detect an activated virtual environment.
### [`VIRTUAL_ENV_DISABLE_PROMPT`](https://docs.astral.sh/uv/reference/environment/#virtual_env_disable_prompt)
added in `0.0.5`
...
### [`ZSH_VERSION`](https://docs.astral.sh/uv/reference/environment/#zsh_version)
added in `0.1.28`
Used to detect Zsh shell usage.
### [`_CONDA_ROOT`](https://docs.astral.sh/uv/reference/environment/#_conda_root)
added in `0.8.18`
