...
- Source URL: https://docs.astral.sh/uv/getting-started/features
- Page Title: Features | uv
- Semantic Filename: features_uv.md
- Ollama Model: llama3.2:3b
- Export Mode: Smart Deep Crawl
- Statistics:
  - Status: Success
  - Content Length: 5,128 characters
---
...
Managing packages in an environment (replacing 
...
Locking packages in an environment (replacing 
