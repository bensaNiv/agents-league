...
- Source URL: https://docs.astral.sh/uv/concepts/projects/layout
- Page Title: Structure and files | uv
- Semantic Filename: structure_and_files_uv.md
- Ollama Model: llama3.2:3b
- Export Mode: Smart Deep Crawl
- Statistics:
  - Status: Success
  - Content Length: 5,601 characters
---
...
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/projects/layout/#__codelineno-0-1)[project]
[](https://docs.astral.sh/uv/concepts/projects/layout/#__codelineno-0-2)name="example"
[](https://docs.astral.sh/uv/concepts/projects/layout/#__codelineno-0-3)version="0.1.0"
...
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/projects/layout/#__codelineno-1-1)[tool.uv]
[](https://docs.astral.sh/uv/concepts/projects/layout/#__codelineno-1-2)managed=false
