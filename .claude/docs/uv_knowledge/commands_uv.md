...
- Source URL: https://docs.astral.sh/uv/reference/cli
- Page Title: Commands | uv
- Semantic Filename: commands_uv.md
- Ollama Model: llama3.2:3b
- Export Mode: Smart Deep Crawl
- Statistics:
  - Status: Success
  - Content Length: 743,257 characters
---
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-0-1)uv [OPTIONS] <COMMAND>
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-1-1)uv auth [OPTIONS] <COMMAND>
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-2-1)uv auth login [OPTIONS] <SERVICE>
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-3-1)uv auth logout [OPTIONS] <SERVICE>
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-4-1)uv auth token [OPTIONS] <SERVICE>
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-5-1)uv auth dir [OPTIONS] [SERVICE]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-6-1)uv run [OPTIONS] [COMMAND]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-7-1)uv init [OPTIONS] [PATH]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-8-1)uv add [OPTIONS] <PACKAGES|--requirements <REQUIREMENTS>>
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-9-1)uv remove [OPTIONS] <PACKAGES>...
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-10-1)uv version [OPTIONS] [VALUE]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-11-1)uv sync [OPTIONS]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-12-1)uv lock [OPTIONS]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-13-1)uv export [OPTIONS]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-14-1)uv tree [OPTIONS]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-15-1)uv format [OPTIONS] [-- <EXTRA_ARGS>...]

```

### Arguments 

[EXTRA_ARGS](https://docs.astral.sh/uv/reference/cli/#uv-format--extra_args)
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-16-1)uv tool [OPTIONS] <COMMAND>
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-17-1)uv tool run [OPTIONS] [COMMAND]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-18-1)uv tool install [OPTIONS] <PACKAGE>
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-19-1)uv tool upgrade [OPTIONS] <NAME>...
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-20-1)uv tool list [OPTIONS]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-21-1)uv tool uninstall [OPTIONS] <NAME>...
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-22-1)uv tool update-shell [OPTIONS]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-23-1)uv tool dir [OPTIONS]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-24-1)uv python [OPTIONS] <COMMAND>
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-25-1)uv python list [OPTIONS] [REQUEST]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-26-1)uv python install [OPTIONS] [TARGETS]...
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-27-1)uv python upgrade [OPTIONS] [TARGETS]...
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-28-1)uv python find [OPTIONS] [REQUEST]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-29-1)uv python pin [OPTIONS] [REQUEST]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-30-1)uv python dir [OPTIONS]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-31-1)uv python uninstall [OPTIONS] <TARGETS>...
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-32-1)uv python update-shell [OPTIONS]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-33-1)uv pip [OPTIONS] <COMMAND>
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-34-1)uv pip compile [OPTIONS] <SRC_FILE|--group <GROUP>>

```

### Arguments 

[SRC_FILE](https://docs.astral.sh/uv/reference/cli/#uv-pip-compile--src_file)
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-35-1)uv pip sync [OPTIONS] <SRC_FILE>...

```

### Arguments 

[SRC_FILE](https://docs.astral.sh/uv/reference/cli/#uv-pip-sync--src_file)
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-36-1)uv pip install [OPTIONS] <PACKAGE|--requirements <REQUIREMENTS>|--editable <EDITABLE>|--group <GROUP>>
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-37-1)uv pip uninstall [OPTIONS] <PACKAGE|--requirements <REQUIREMENTS>>
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-38-1)uv pip freeze [OPTIONS]
...
[`--target`](https://docs.astral.sh/uv/reference/cli/#uv-pip-freeze--target) _target_ 
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-39-1)uv pip list [OPTIONS]
...
[`--target`](https://docs.astral.sh/uv/reference/cli/#uv-pip-list--target) _target_ 
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-40-1)uv pip show [OPTIONS] [PACKAGE]...
...
[`--target`](https://docs.astral.sh/uv/reference/cli/#uv-pip-show--target) _target_ 
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-41-1)uv pip tree [OPTIONS]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-42-1)uv pip check [OPTIONS]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-43-1)uv venv [OPTIONS] [PATH]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-44-1)uv build [OPTIONS] [SRC]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-45-1)uv publish [OPTIONS] [FILES]...
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-46-1)uv cache [OPTIONS] <COMMAND>
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-47-1)uv cache clean [OPTIONS] [PACKAGE]...
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-48-1)uv cache prune [OPTIONS]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-49-1)uv cache dir [OPTIONS]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-50-1)uv cache size [OPTIONS]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-51-1)uv self [OPTIONS] <COMMAND>
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-52-1)uv self update [OPTIONS] [TARGET_VERSION]

```

### Arguments 

[TARGET_VERSION](https://docs.astral.sh/uv/reference/cli/#uv-self-update--target_version)
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-53-1)uv self version [OPTIONS]
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-54-1)uv generate-shell-completion [OPTIONS] <SHELL>
...
### Usage
```
[](https://docs.astral.sh/uv/reference/cli/#__codelineno-55-1)uv help [OPTIONS] [COMMAND]...
...
Use verbose output.
You can configure fine-grained logging using the `RUST_LOG` environment variable. ( December 8, 2025
