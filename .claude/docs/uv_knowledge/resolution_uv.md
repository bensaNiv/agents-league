...
- Source URL: https://docs.astral.sh/uv/concepts/resolution
- Page Title: Resolution | uv
- Semantic Filename: resolution_uv.md
- Ollama Model: llama3.2:3b
- Export Mode: Smart Deep Crawl
- Statistics:
  - Status: Success
  - Content Length: 44,021 characters
---

# Resolution | uv

[ Skip to content ](https://docs.astral.sh/uv/concepts/resolution/#resolution)
# [Resolution](https://docs.astral.sh/uv/concepts/resolution/#resolution)
...
## [Dependencies](https://docs.astral.sh/uv/concepts/resolution/#dependencies)
...
Note
See the 
## [Basic examples](https://docs.astral.sh/uv/concepts/resolution/#basic-examples)
...
uv supports both [platform-specific](https://docs.astral.sh/uv/concepts/resolution/#platform-specific-resolution) and [universal](https://docs.astral.sh/uv/concepts/resolution/#universal-resolution) resolution.
...
When selecting the compatible version for a given dependency, uv will ([by default](https://docs.astral.sh/uv/concepts/resolution/#multi-version-resolution)) attempt to choose the latest compatible version for each supported Python version. For example, if a project's `requires-python` is `>=3.8`, and the latest version of a dependency requires Python 3.9 or later, while all prior versions supporting Python 3.8, the resolver will select the latest version for users running Python 3.9 or later, and previous versions for users running Python 3.8.
When evaluating `requires-python` ranges for dependencies, uv only considers lower bounds and ignores upper bounds entirely. For example, `>=3.8, <4` is treated as `>=3.8`. Respecting upper bounds on `requires-python` often leads to formally correct but practically incorrect resolutions, as, e.g., resolvers will backtrack to the first published version that omits the upper bound (see: 
## [Limited resolution environments](https://docs.astral.sh/uv/concepts/resolution/#limited-resolution-environments)
By default, the universal resolver attempts to solve for all platforms and Python versions.
If your project supports only a limited set of platforms or Python versions, you can constrain the set of solved platforms via the `environments` setting, which accepts a list of `environments` setting to _reduce_ the set of supported platforms.
For example, to constrain the lockfile to macOS and Linux, and avoid solving for Windows:
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-0-1)[tool.uv]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-0-2)environments=[
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-0-3)"sys_platform == 'darwin'",
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-0-4)"sys_platform == 'linux'",
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-0-5)]

```

Or, to avoid solving for alternative Python implementations:
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-1-1)[tool.uv]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-1-2)environments=[
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-1-3)"implementation_name == 'cpython'"
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-1-4)]
...
## [Required environments](https://docs.astral.sh/uv/concepts/resolution/#required-environments)
...
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-2-1)[tool.uv]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-2-2)required-environments=[
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-2-3)"sys_platform == 'darwin' and platform_machine == 'x86_64'"
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-2-4)]

```

## [Dependency preferences](https://docs.astral.sh/uv/concepts/resolution/#dependency-preferences)
...
requirements.in```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-3-1)flask>=2.0.0

```

Running `uv pip compile requirements.in` would produce the following `requirements.txt` file:
requirements.txt```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-4-1)# This file was autogenerated by uv via the following command:
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-4-2)#    uv pip compile requirements.in
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-4-3)blinker==1.7.0
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-4-4)    # via flask
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-4-5)click==8.1.7
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-4-6)    # via flask
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-4-7)flask==3.0.0
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-4-8)itsdangerous==2.1.2
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-4-9)    # via flask
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-4-10)jinja2==3.1.2
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-4-11)    # via flask
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-4-12)markupsafe==2.1.3
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-4-13)    # via
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-4-14)    #   jinja2
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-4-15)    #   werkzeug
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-4-16)werkzeug==3.0.1
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-4-17)    # via flask

```

However, `uv pip compile --resolution lowest requirements.in` would instead produce:
requirements.in```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-5-1)# This file was autogenerated by uv via the following command:
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-5-2)#    uv pip compile requirements.in --resolution lowest
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-5-3)click==7.1.2
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-5-4)    # via flask
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-5-5)flask==2.0.0
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-5-6)itsdangerous==2.0.0
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-5-7)    # via flask
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-5-8)jinja2==3.0.0
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-5-9)    # via flask
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-5-10)markupsafe==2.0.0
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-5-11)    # via jinja2
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-5-12)werkzeug==2.0.0
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-5-13)    # via flask
...
## [Pre-release handling](https://docs.astral.sh/uv/concepts/resolution/#pre-release-handling)
...
```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-6-1)numpy==1.24.4 ; python_version == "3.8"
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-6-2)numpy==2.0.2 ; python_version == "3.9"
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-6-3)numpy==2.2.0 ; python_version >= "3.10"
...
## [Dependency constraints](https://docs.astral.sh/uv/concepts/resolution/#dependency-constraints)
...
## [Dependency overrides](https://docs.astral.sh/uv/concepts/resolution/#dependency-overrides)
...
If multiple overrides are provided for the same package, they must be differentiated with [markers](https://docs.astral.sh/uv/concepts/resolution/#platform-markers). If a package has a dependency with a marker, it is replaced unconditionally when using overrides — it does not matter if the marker evaluates to true or false.
## [Dependency metadata](https://docs.astral.sh/uv/concepts/resolution/#dependency-metadata)
...
```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-7-1)[[tool.uv.dependency-metadata]]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-7-2)name="chumpy"
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-7-3)version="0.70"
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-7-4)requires-dist=["numpy>=1.8.1","scipy>=0.13.0","six>=1.11.0"]

```

These declarations are intended for cases in which a package does _not_ declare static metadata upfront, though they are also useful for packages that require [disabling build isolation](https://docs.astral.sh/uv/concepts/projects/config/#build-isolation) In such cases, it may be easier to declare the package metadata upfront, rather than creating a custom build environment prior to resolving the package.
...
```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-8-1)[project]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-8-2)name="project"
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-8-3)version="0.1.0"
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-8-4)requires-python=">=3.12"
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-8-5)dependencies=["flash-attn"]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-8-6)
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-8-7)[tool.uv.sources]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-8-8)flash-attn={git="https://github.com/Dao-AILab/flash-attention",tag="v2.6.3"}
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-8-9)
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-8-10)[[tool.uv.dependency-metadata]]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-8-11)name="flash-attn"
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-8-12)version="2.6.3"
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-8-13)requires-dist=["torch","einops"]
...
Entries in the `tool.uv.dependency-metadata` table follow the `name`, `version`, `requires-dist`, `requires-python`, and `provides-extra` are read by uv. The `version` field is also considered optional. If omitted, the metadata will be used for all versions of the specified package.
## [Conflicting dependencies](https://docs.astral.sh/uv/concepts/resolution/#conflicting-dependencies)
...
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-9-1)[project.optional-dependencies]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-9-2)extra1=["numpy==2.1.2"]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-9-3)extra2=["numpy==2.0.0"]

```

If you run `uv lock` with the above dependencies, resolution will fail:
```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-10-1)$ uv[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-10-2)  x No solution found when resolving dependencies:
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-10-3)  `-> Because myproject[extra2] depends on numpy==2.0.0 and myproject[extra1] depends on numpy==2.1.2, we can conclude that myproject[extra1] and
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-10-4)      myproject[extra2] are incompatible.
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-10-5)      And because your project requires myproject[extra1] and myproject[extra2], we can conclude that your projects's requirements are unsatisfiable.
...
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-11-1)[tool.uv]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-11-2)conflicts=[
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-11-3)[
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-11-4){extra="extra1"},
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-11-5){extra="extra2"},
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-11-6)],
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-11-7)]

```

Now, running `uv lock` will succeed. However, now you cannot install both `extra1` and `extra2` at the same time:
```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-12-1)$ uv[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-12-2)Resolved 3 packages in 14ms
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-12-3)error: extra `extra1`, extra `extra2` are incompatible with the declared conflicts: {`myproject[extra1]`, `myproject[extra2]`}
...
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-13-1)[dependency-groups]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-13-2)group1=["numpy==2.1.2"]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-13-3)group2=["numpy==2.0.0"]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-13-4)
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-13-5)[tool.uv]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-13-6)conflicts=[
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-13-7)[
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-13-8){group="group1"},
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-13-9){group="group2"},
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-13-10)],
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-13-11)]
...
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-14-1)[project]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-14-2)name="member1"
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-14-3)
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-14-4)[project.optional-dependencies]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-14-5)extra1=["numpy==2.1.2"]

```

member2/pyproject.toml```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-15-1)[project]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-15-2)name="member2"
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-15-3)
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-15-4)[project.optional-dependencies]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-15-5)extra2=["numpy==2.0.0"]

```

To declare a conflict between extras in these different workspace members, use the `package` key:
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-16-1)[tool.uv]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-16-2)conflicts=[
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-16-3)[
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-16-4){package="member1",extra="extra1"},
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-16-5){package="member2",extra="extra2"},
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-16-6)],
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-16-7)]
...
member1/pyproject.toml```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-17-1)[project]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-17-2)name="member1"
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-17-3)dependencies=["numpy==2.1.2"]

```

member2/pyproject.toml```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-18-1)[project]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-18-2)name="member2"
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-18-3)
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-18-4)[project.optional-dependencies]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-18-5)extra2=["numpy==2.0.0"]

```

This conflict can also be declared using the `package` key:
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-19-1)[tool.uv]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-19-2)conflicts=[
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-19-3)[
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-19-4){package="member1"},
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-19-5){package="member2",extra="extra2"},
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-19-6)],
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-19-7)]

```

Similarly, it's possible for some workspace members to have conflicting project dependencies:
member1/pyproject.toml```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-20-1)[project]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-20-2)name="member1"
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-20-3)dependencies=["numpy==2.1.2"]

```

member2/pyproject.toml```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-21-1)[project]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-21-2)name="member2"
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-21-3)dependencies=["numpy==2.0.0"]

```

This conflict can also be declared using the `package` key:
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-22-1)[tool.uv]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-22-2)conflicts=[
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-22-3)[
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-22-4){package="member1"},
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-22-5){package="member2"},
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-22-6)],
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-22-7)]

```

These workspace members will not be installable together, e.g., the workspace root cannot define:
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-23-1)[project]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-23-2)name="root"
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-23-3)dependencies=["member1","member2"]

```

## [Lower bounds](https://docs.astral.sh/uv/concepts/resolution/#lower-bounds)
...
Lower bounds are particularly critical when writing a library. It's important to declare the lowest version for each dependency that your library works with, and to validate that the bounds are correct — testing with [`--resolution lowest` or `--resolution lowest-direct`](https://docs.astral.sh/uv/concepts/resolution/#resolution-strategy). Otherwise, a user may receive an old, incompatible version of one of your library's dependencies and the library will fail with an unexpected error.
## [Reproducible resolutions](https://docs.astral.sh/uv/concepts/resolution/#reproducible-resolutions)
uv supports an `--exclude-newer` option to limit resolution to distributions published before a specific date, allowing reproduction of installations regardless of new package releases. The date may be specified as an `2006-12-02T02:07:43Z`) or a local date in the same format (e.g., `2006-12-02`) in your system's configured time zone.
Important
The package index must support the `upload-time` field as specified in `upload-time` for all packages.
...
```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-24-1)[tool.uv]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-24-2)exclude-newer = "2006-12-02T02:07:43Z"
...
```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-25-1)[tool.uv]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-25-2)exclude-newer-package = { setuptools = "2006-12-02T02:07:43Z" }
...
This feature is available via the [`exclude-newer` option](https://docs.astral.sh/uv/concepts/resolution/#reproducible-resolutions) and shares the same semantics.
...
This option is also supported in the `pyproject.toml`, e.g.:
```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-26-1)[tool.uv]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-26-2)exclude-newer = "1 week"

```

Values may also be specified for specific packages, e.g., `--exclude-newer-package "setuptools=30 days"`, or:
```
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-27-1)[tool.uv]
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-27-2)exclude-newer = "1 week"
[](https://docs.astral.sh/uv/concepts/resolution/#__codelineno-27-3)exclude-newer-package = { setuptools = "30 days" }

```

## [Source distribution](https://docs.astral.sh/uv/concepts/resolution/#source-distribution)
`.tar.gz`) archives. Prior to this specification, other archive formats, which need to be supported for backward compatibility, were also allowed. uv supports reading and extracting archives in the following formats:
...
## [Lockfile versioning](https://docs.astral.sh/uv/concepts/resolution/#lockfile-versioning)
...
## [Learn more](https://docs.astral.sh/uv/concepts/resolution/#learn-more)
For more details about the internals of the resolver, see the [resolver reference](https://docs.astral.sh/uv/reference/internals/resolver/) documentation.
December 9, 2025
