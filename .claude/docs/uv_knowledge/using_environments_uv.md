...
- Source URL: https://docs.astral.sh/uv/pip/environments
- Page Title: Using environments | uv
- Semantic Filename: using_environments_uv.md
- Ollama Model: llama3.2:3b
- Export Mode: Smart Deep Crawl
- Statistics:
  - Status: Success
  - Content Length: 7,157 characters
---

# Using environments | uv

[ Skip to content ](https://docs.astral.sh/uv/pip/environments/#using-python-environments)
...
```
[](https://docs.astral.sh/uv/pip/environments/#__codelineno-0-1)$ uv
```

A specific name or path can be specified, e.g., to create a virtual environment at `my-name`:
```
[](https://docs.astral.sh/uv/pip/environments/#__codelineno-1-1)$ uv
```

A Python version can be requested, e.g., to create a virtual environment with Python 3.11:
```
[](https://docs.astral.sh/uv/pip/environments/#__codelineno-2-1)$ uv3.11
...
```
[](https://docs.astral.sh/uv/pip/environments/#__codelineno-3-1)$ uv[](https://docs.astral.sh/uv/pip/environments/#__codelineno-3-2)
[](https://docs.astral.sh/uv/pip/environments/#__codelineno-3-3)$ # Install a package in the new virtual environment
[](https://docs.astral.sh/uv/pip/environments/#__codelineno-3-4)$ uv
```

The virtual environment can be "activated" to make its packages available:
[macOS and Linux](https://docs.astral.sh/uv/pip/environments/#__tabbed_1_1)[Windows](https://docs.astral.sh/uv/pip/environments/#__tabbed_1_2)
```
[](https://docs.astral.sh/uv/pip/environments/#__codelineno-4-1)$ source
```

```
[](https://docs.astral.sh/uv/pip/environments/#__codelineno-5-1)PS> .venv\Scripts\activate
...
[fish](https://docs.astral.sh/uv/pip/environments/#__tabbed_2_1)[csh / tcsh](https://docs.astral.sh/uv/pip/environments/#__tabbed_2_2)[Nushell](https://docs.astral.sh/uv/pip/environments/#__tabbed_2_3)
```
[](https://docs.astral.sh/uv/pip/environments/#__codelineno-6-1)$ source
```

```
[](https://docs.astral.sh/uv/pip/environments/#__codelineno-7-1)$ source
```

```
[](https://docs.astral.sh/uv/pip/environments/#__codelineno-8-1)$ use\Scripts\activate.nu
...
```
[](https://docs.astral.sh/uv/pip/environments/#__codelineno-9-1)$ deactivate

```

## [Using arbitrary Python environments](https://docs.astral.sh/uv/pip/environments/#using-arbitrary-python-environments)
Since uv has no dependency on Python, it can install into virtual environments other than its own. For example, setting `VIRTUAL_ENV=/path/to/venv` will cause uv to install into `/path/to/venv`, regardless of where uv is installed. Note that if `VIRTUAL_ENV` is set to a directory that is **not** a 
...
Installing into system Python across platforms and distributions is notoriously difficult. uv supports the common cases, but will not work in all cases. For example, installing into system Python on Debian prior to Python 3.10 is unsupported due to the 
