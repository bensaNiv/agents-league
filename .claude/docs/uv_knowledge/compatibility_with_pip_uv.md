...
- Source URL: https://docs.astral.sh/uv/pip/compatibility
- Page Title: Compatibility with pip | uv
- Semantic Filename: compatibility_with_pip_uv.md
- Ollama Model: llama3.2:3b
- Export Mode: Smart Deep Crawl
- Statistics:
  - Status: Success
  - Content Length: 28,920 characters
---

# Compatibility with pip | uv

[ Skip to content ](https://docs.astral.sh/uv/pip/compatibility/#compatibility-with-pip-and-pip-tools)
# [Compatibility with `pip` and `pip-tools`](https://docs.astral.sh/uv/pip/compatibility/#compatibility-with-pip-and-pip-tools)
...
## [Configuration files and environment variables](https://docs.astral.sh/uv/pip/compatibility/#configuration-files-and-environment-variables)
...
Instead, uv supports its own environment variables, like `UV_INDEX_URL`. uv also supports persistent configuration in a `uv.toml` file or a `[tool.uv.pip]` section of `pyproject.toml`. For more information, see [Configuration files](https://docs.astral.sh/uv/concepts/configuration-files/).
## [Pre-release compatibility](https://docs.astral.sh/uv/pip/compatibility/#pre-release-compatibility)
...
Pre-releases are `pip`, which is viewed as a reference implementation, has a number of open questions around pre-release handling (_intentionally_ limited and _intentionally_ requires user opt-in for pre-releases, to ensure correctness.
In the future, uv _may_ support pre-release identifiers in transitive dependencies. However, it's likely contingent on evolution in the Python packaging specifications. The existing PEPs _single_ version specifier. As such, there are unresolved questions around the correct and intended behavior for pre-releases in the packaging ecosystem more broadly.
## [Packages that exist on multiple indexes](https://docs.astral.sh/uv/pip/compatibility/#packages-that-exist-on-multiple-indexes)
...
For example, imagine that a company publishes an internal version of `requests` on a private index (`--extra-index-url`), but also allows installing packages from PyPI by default. In this case, the private `requests` would conflict with the public 
...
`pip`, meanwhile, will combine the candidate versions from all indexes, and select the best version from the combined set, though it makes 
...
uv also supports pinning packages to dedicated indexes (see: [_Indexes_](https://docs.astral.sh/uv/concepts/indexes/#pinning-a-package-to-an-index)), such that a given package is _always_ installed from a specific index.
## [PEP 517 build isolation](https://docs.astral.sh/uv/pip/compatibility/#pep-517-build-isolation)
uv uses `pip install --use-pep517`), following `pypa/build` and in anticipation of `pip` defaulting to PEP 517 builds in the future (
...
```
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-0-1)uv&&biopython==1.77

```

For a list of packages that are known to fail under PEP 517 build isolation, see 
## [Transitive URL dependencies](https://docs.astral.sh/uv/pip/compatibility/#transitive-url-dependencies)
...
## [Virtual environments by default](https://docs.astral.sh/uv/pip/compatibility/#virtual-environments-by-default)
...
For more, see ["Using arbitrary Python environments"](https://docs.astral.sh/uv/pip/environments/#using-arbitrary-python-environments).
## [Resolution strategy](https://docs.astral.sh/uv/pip/compatibility/#resolution-strategy)
...
requirements.in```
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-1-1)starlette
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-1-2)fastapi
...
requirements.txt```
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-1)# This file was autogenerated by uv via the following command:
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-2)#    uv pip compile requirements.in
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-3)annotated-types==0.6.0
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-4)    # via pydantic
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-5)anyio==4.3.0
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-6)    # via starlette
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-7)fastapi==0.1.17
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-8)idna==3.6
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-9)    # via anyio
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-10)pydantic==2.6.3
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-11)    # via fastapi
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-12)pydantic-core==2.16.3
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-13)    # via pydantic
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-14)sniffio==1.3.1
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-15)    # via anyio
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-16)starlette==0.37.2
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-17)    # via fastapi
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-18)typing-extensions==4.10.0
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-19)    # via
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-20)    #   pydantic
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-2-21)    #   pydantic-core
...
requirements.txt```
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-1)# This file was autogenerated by uv via the following command:
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-2)#    uv pip compile requirements.in
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-3)annotated-types==0.6.0
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-4)    # via pydantic
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-5)anyio==4.3.0
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-6)    # via starlette
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-7)fastapi==0.110.0
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-8)idna==3.6
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-9)    # via anyio
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-10)pydantic==2.6.3
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-11)    # via fastapi
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-12)pydantic-core==2.16.3
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-13)    # via pydantic
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-14)sniffio==1.3.1
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-15)    # via anyio
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-16)starlette==0.36.3
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-17)    # via fastapi
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-18)typing-extensions==4.10.0
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-19)    # via
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-20)    #   fastapi
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-21)    #   pydantic
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-3-22)    #   pydantic-core
...
## [`pip check`](https://docs.astral.sh/uv/pip/compatibility/#pip-check)
...
## [`--user` and the `user` install scheme](https://docs.astral.sh/uv/pip/compatibility/#-user-and-the-user-install-scheme)
...
For more, see 
## [`--only-binary` enforcement](https://docs.astral.sh/uv/pip/compatibility/#-only-binary-enforcement)
...
## [`--no-binary` enforcement](https://docs.astral.sh/uv/pip/compatibility/#-no-binary-enforcement)
...
## [`manylinux_compatible` enforcement](https://docs.astral.sh/uv/pip/compatibility/#manylinux_compatible-enforcement)
`manylinux` compatibility by defining a `manylinux_compatible` function on the `_manylinux` standard library module.
...
This approach is not a complete implementation of the spec, but is compatible with common blanket `manylinux_compatible` implementations like 
```
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-4-1)from __future__ import annotations
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-4-2)manylinux1_compatible = False
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-4-3)manylinux2010_compatible = False
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-4-4)manylinux2014_compatible = False
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-4-5)
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-4-6)
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-4-7)def manylinux_compatible(*_, **__):  # PEP 600
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-4-8)    return False

```

## [Bytecode compilation](https://docs.astral.sh/uv/pip/compatibility/#bytecode-compilation)
...
## [Strictness and spec enforcement](https://docs.astral.sh/uv/pip/compatibility/#strictness-and-spec-enforcement)
uv tends to be stricter than `pip`, and will often reject packages that `pip` would install. For example, uv rejects HTML indexes with invalid URL fragments (see: `pip` will ignore such fragments.
...
## [`pip` command-line options and subcommands](https://docs.astral.sh/uv/pip/compatibility/#pip-command-line-options-and-subcommands)
...
## [Registry authentication](https://docs.astral.sh/uv/pip/compatibility/#registry-authentication)
...
## [`egg` support](https://docs.astral.sh/uv/pip/compatibility/#egg-support)
...
## [Build constraints](https://docs.astral.sh/uv/pip/compatibility/#build-constraints)
...
## [`pip compile` defaults](https://docs.astral.sh/uv/pip/compatibility/#pip-compile-defaults)
...
## [`requires-python` upper bounds](https://docs.astral.sh/uv/pip/compatibility/#requires-python-upper-bounds)
...
## [`requires-python` specifiers](https://docs.astral.sh/uv/pip/compatibility/#requires-python-specifiers)
...
While this is not strictly compliant with _is_ consistent with 
## [Package priority](https://docs.astral.sh/uv/pip/compatibility/#package-priority)
There are usually many possible solutions given a set of requirements, and a resolver must choose between them. uv's resolver and pip's resolver have a different set of package priorities. While both resolvers use the user-provided order as one of their priorities, pip has additional 
...
## [Wheel filename and metadata validation](https://docs.astral.sh/uv/pip/compatibility/#wheel-filename-and-metadata-validation)
...
## [Package name normalization](https://docs.astral.sh/uv/pip/compatibility/#package-name-normalization)
...
```
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-5-1)(venv)(pip)(uv)
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-5-2)Package[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-5-3)----------------[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-5-4)docstring_parser0.16|0.16
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-5-5)jaraco.classes3.4.0|3.4.0
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-5-6)more-itertools10.7.010.7.0
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-5-7)pip25.125.1
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-5-8)PyMuPDFb1.24.10|1.24.10
[](https://docs.astral.sh/uv/pip/compatibility/#__codelineno-5-9)PyPDF23.0.1|3.0.1
