...
- Source URL: https://docs.astral.sh/uv/guides/integration/jupyter
- Page Title: Using uv with Jupyter | uv
- Semantic Filename: using_uv_with_jupyter_uv.md
- Ollama Model: llama3.2:3b
- Export Mode: Smart Deep Crawl
- Statistics:
  - Status: Success
  - Content Length: 8,409 characters
---
...
If you're working within a [project](https://docs.astral.sh/uv/concepts/projects/), you can start a Jupyter server with access to the project's virtual environment via the following:
```
[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-0-1)$ uv
```
...
```
[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-1-1)$ uv
```

Then, you can create the kernel for `project` with:
```
[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-2-1)$ uv$(pwd)/.venv=project

```

From there, start the server with:
```
[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-3-1)$ uv
```
...
```
[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-4-1)$ uv[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-4-2)$ uv
```
...
If you need to run Jupyter in a virtual environment that isn't associated with a [project](https://docs.astral.sh/uv/concepts/projects/) (e.g., has no `pyproject.toml` or `uv.lock`), you can do so by adding Jupyter to the environment directly. For example:
...
```
[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-5-1)$ uv[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-5-2)$ uv[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-5-3)$ uv[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-5-4)$ .venv/bin/jupyter
```

```
[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-6-1)PS> uv venv --seed
[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-6-2)PS> uv pip install pydantic
[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-6-3)PS> uv pip install jupyterlab
[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-6-4)PS> .venv\Scripts\jupyter lab
...
```
[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-7-1)# Create[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-7-2)$ uv[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-7-3)
[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-7-4)# Move[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-7-5)$ cd[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-7-6)
[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-7-7)# Add[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-7-8)$ uv[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-7-9)
[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-7-10)# Openin[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-7-11)$ code
```
...
```
[](https://docs.astral.sh/uv/guides/integration/jupyter/#__codelineno-8-1)$ uv
```
