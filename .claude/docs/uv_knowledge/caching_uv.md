...
- Source URL: https://docs.astral.sh/uv/concepts/cache
- Page Title: Caching | uv
- Semantic Filename: caching_uv.md
- Ollama Model: llama3.2:3b
- Export Mode: Smart Deep Crawl
- Statistics:
  - Status: Success
  - Content Length: 11,358 characters
---

# Caching | uv

[ Skip to content ](https://docs.astral.sh/uv/concepts/cache/#caching)
...
For example, if a project specifies dependencies in `pyproject.toml` but uses `pyproject.toml`:
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/cache/#__codelineno-0-1)[tool.uv]
[](https://docs.astral.sh/uv/concepts/cache/#__codelineno-0-2)cache-keys=[{file="pyproject.toml"},{git={commit=true}}]
...
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/cache/#__codelineno-1-1)[tool.uv]
[](https://docs.astral.sh/uv/concepts/cache/#__codelineno-1-2)cache-keys=[{file="pyproject.toml"},{git={commit=true,tags=true}}]
...
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/cache/#__codelineno-2-1)[tool.uv]
[](https://docs.astral.sh/uv/concepts/cache/#__codelineno-2-2)cache-keys=[{file="pyproject.toml"},{file="requirements.txt"}]

```

Globs are supported for `file` keys, following the syntax of the `.toml` file in the project directory or any of its subdirectories is modified, use the following:
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/cache/#__codelineno-3-1)[tool.uv]
[](https://docs.astral.sh/uv/concepts/cache/#__codelineno-3-2)cache-keys=[{file="**/*.toml"}]
...
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/cache/#__codelineno-4-1)[tool.uv]
[](https://docs.astral.sh/uv/concepts/cache/#__codelineno-4-2)cache-keys=[{file="pyproject.toml"},{env="MY_ENV_VAR"}]
...
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/cache/#__codelineno-5-1)[tool.uv]
[](https://docs.astral.sh/uv/concepts/cache/#__codelineno-5-2)cache-keys=[{file="pyproject.toml"},{dir="src"}]
...
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/cache/#__codelineno-6-1)[tool.uv]
[](https://docs.astral.sh/uv/concepts/cache/#__codelineno-6-2)reinstall-package=["my-package"]
