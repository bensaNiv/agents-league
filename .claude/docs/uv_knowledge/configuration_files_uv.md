...
- Source URL: https://docs.astral.sh/uv/concepts/configuration-files
- Page Title: Configuration files | uv
- Semantic Filename: configuration_files_uv.md
- Ollama Model: llama3.2:3b
- Export Mode: Smart Deep Crawl
- Statistics:
  - Status: Success
  - Content Length: 6,749 characters
---

# Configuration files | uv
...
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/configuration-files/#__codelineno-0-1)[[tool.uv.index]]
[](https://docs.astral.sh/uv/concepts/configuration-files/#__codelineno-0-2)url="https://test.pypi.org/simple"
[](https://docs.astral.sh/uv/concepts/configuration-files/#__codelineno-0-3)default=true
...
uv.toml```
[](https://docs.astral.sh/uv/concepts/configuration-files/#__codelineno-1-1)[[index]]
[](https://docs.astral.sh/uv/concepts/configuration-files/#__codelineno-1-2)url="https://test.pypi.org/simple"
[](https://docs.astral.sh/uv/concepts/configuration-files/#__codelineno-1-3)default=true
...
uv will also discover `uv.toml` configuration files in the user- and system-level [configuration directories](https://docs.astral.sh/uv/reference/storage/#configuration-directories), e.g., user-level configuration in `~/.config/uv/uv.toml`, and system-level configuration at `/etc/uv/uv.toml` on macOS and Linux.
Important
...
`uv run` can load environment variables from dotenv files (e.g., `.env`, `.env.local`, `.env.development`), powered by the 
...
```
[](https://docs.astral.sh/uv/concepts/configuration-files/#__codelineno-2-1)$ echo"MY_VAR='Hello, world!'"[](https://docs.astral.sh/uv/concepts/configuration-files/#__codelineno-2-2)$ uv'import os; print(os.getenv("MY_VAR"))'
[](https://docs.astral.sh/uv/concepts/configuration-files/#__codelineno-2-3)Hello, world!
...
pyproject.toml```
[](https://docs.astral.sh/uv/concepts/configuration-files/#__codelineno-3-1)[tool.uv.pip]
[](https://docs.astral.sh/uv/concepts/configuration-files/#__codelineno-3-2)index-url="https://test.pypi.org/simple"
