...
- Source URL: https://docs.astral.sh/uv/concepts/python-versions
- Page Title: Python versions | uv
- Semantic Filename: python_versions_uv.md
- Ollama Model: llama3.2:3b
- Export Mode: Smart Deep Crawl
- Statistics:
  - Status: Success
  - Content Length: 22,232 characters
---
...
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-0-1)$ uv3.11.6
...
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-1-1)$ uv3.12.3

```

To install the latest patch version:
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-2-1)$ uv3.12

```

To install a version that satisfies constraints:
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-3-1)$ uv'>=3.8,<3.10'

```

To install multiple versions:
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-4-1)$ uv3.93.103.11

```

To install a specific implementation:
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-5-1)$ uv
```
...
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-6-1)$ uv3.12
```
...
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-7-1)$ uv3.12.7# Adds `python3.12` to `~/.local/bin`
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-7-2)$ uv3.12.6# Does not update `python3.12`
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-7-3)$ uv3.12.8# Updates `python3.12` to point to 3.12.8

```

## [Upgrading Python versions](https://docs.astral.sh/uv/concepts/python-versions/#upgrading-python-versions)
Important
Support for upgrading Python versions is in _preview_. This means the behavior is experimental and subject to change.
...
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-8-1)$ uv3.12

```

To upgrade all installed Python versions:
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-9-1)$ uv
```
...
Note
If the virtual environment was created _before_ opting in to the preview mode, it will not be included in the automatic upgrades.
...
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-10-1)~/.local/share/uv/python/cpython-3.12-macos-aarch64-none

```

which is a symbolic link (on Unix) or junction (on Windows) pointing to a specific patch version:
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-11-1)$ readlink[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-11-2)~/.local/share/uv/python/cpython-3.12.11-macos-aarch64-none
...
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-12-1)$ uv
```

To filter the Python versions, provide a request, e.g., to show all Python 3.13 interpreters:
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-13-1)$ uv3.13

```

Or, to show all PyPy interpreters:
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-14-1)$ uv
```

By default, downloads for other platforms and old patch versions are hidden.
To view all versions:
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-15-1)$ uv
```

To view Python versions for other platforms:
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-16-1)$ uv
```

To exclude downloads and only show installed Python versions:
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-17-1)$ uv
```
...
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-18-1)$ uv
```
...
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-19-1)$ uv'>=3.11'
...
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-20-1)$ uv
```
...
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-21-1)$ uv
```

Similarly, to ignore managed Python versions and only use system Python versions, use the `--no-managed-python` flag:
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-22-1)$ uv
```
...
As Python does not publish official distributable CPython binaries, uv instead uses pre-built distributions from the Astral `python-build-standalone` is also is used in many other Python projects, like 
...
On Windows, installation of managed Python versions will register them with the Windows registry as defined by 
After installation, the Python versions can be selected with the `py` launcher, e.g.:
```
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-23-1)$ uv3.13.1
[](https://docs.astral.sh/uv/concepts/python-versions/#__codelineno-23-2)$ py
```
