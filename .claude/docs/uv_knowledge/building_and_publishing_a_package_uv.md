...
- Source URL: https://docs.astral.sh/uv/guides/package
- Page Title: Building and publishing a package | uv
- Semantic Filename: building_and_publishing_a_package_uv.md
- Ollama Model: llama3.2:3b
- Export Mode: Smart Deep Crawl
- Statistics:
  - Status: Success
  - Content Length: 9,232 characters
---
...
## [Preparing your project](https://docs.astral.sh/uv/guides/package/#preparing-your-project)
...
```
[](https://docs.astral.sh/uv/guides/package/#__codelineno-0-1)$ uv
```
...
```
[](https://docs.astral.sh/uv/guides/package/#__codelineno-1-1)$ uv1.0.0
[](https://docs.astral.sh/uv/guides/package/#__codelineno-1-2)hello-world 0.7.0 => 1.0.0

```

To preview the change without updating the `pyproject.toml`, use the `--dry-run` flag:
```
[](https://docs.astral.sh/uv/guides/package/#__codelineno-2-1)$ uv2.0.0[](https://docs.astral.sh/uv/guides/package/#__codelineno-2-2)hello-world 1.0.0 => 2.0.0
[](https://docs.astral.sh/uv/guides/package/#__codelineno-2-3)$ uv[](https://docs.astral.sh/uv/guides/package/#__codelineno-2-4)hello-world 1.0.0

```

To increase the version of your package semantics, use the `--bump` option:
```
[](https://docs.astral.sh/uv/guides/package/#__codelineno-3-1)$ uv[](https://docs.astral.sh/uv/guides/package/#__codelineno-3-2)hello-world 1.2.3 => 1.3.0
...
```
[](https://docs.astral.sh/uv/guides/package/#__codelineno-4-1)$ uvdev=66463664
[](https://docs.astral.sh/uv/guides/package/#__codelineno-4-2)hello-world 0.0.1 => 0.0.2.dev66463664
...
```
[](https://docs.astral.sh/uv/guides/package/#__codelineno-5-1)$ uv[](https://docs.astral.sh/uv/guides/package/#__codelineno-5-2)hello-world 1.3.0 => 1.3.1b1
[](https://docs.astral.sh/uv/guides/package/#__codelineno-5-3)$ uv[](https://docs.astral.sh/uv/guides/package/#__codelineno-5-4)hello-world 1.3.0 => 2.0.0a1

```

When moving from a pre-release to a new pre-release version, just bump the relevant pre-release component:
```
[](https://docs.astral.sh/uv/guides/package/#__codelineno-6-1)$ uv[](https://docs.astral.sh/uv/guides/package/#__codelineno-6-2)hello-world 1.3.0b1 => 1.3.0b2

```

When moving from a pre-release to a stable version, the `stable` option can be used to clear the pre-release component:
```
[](https://docs.astral.sh/uv/guides/package/#__codelineno-7-1)$ uv[](https://docs.astral.sh/uv/guides/package/#__codelineno-7-2)hello-world 1.3.1b2 => 1.3.1
...
```
[](https://docs.astral.sh/uv/guides/package/#__codelineno-8-1)$ uv
```

Set a PyPI token with `--token` or `UV_PUBLISH_TOKEN`, or set a username with `--username` or `UV_PUBLISH_USERNAME` and password with `--password` or `UV_PUBLISH_PASSWORD`. For publishing to PyPI from GitHub Actions or another Trusted Publisher, you don't need to set any credentials. Instead, 
Note
...
```
[](https://docs.astral.sh/uv/guides/package/#__codelineno-9-1)[[tool.uv.index]]
[](https://docs.astral.sh/uv/guides/package/#__codelineno-9-2)name="testpypi"
[](https://docs.astral.sh/uv/guides/package/#__codelineno-9-3)url="https://test.pypi.org/simple/"
[](https://docs.astral.sh/uv/guides/package/#__codelineno-9-4)publish-url="https://test.pypi.org/legacy/"
[](https://docs.astral.sh/uv/guides/package/#__codelineno-9-5)explicit=true
...
### [Uploading attestations with your package](https://docs.astral.sh/uv/guides/package/#uploading-attestations-with-your-package)
Note
...
```
[](https://docs.astral.sh/uv/guides/package/#__codelineno-10-1)$ ls[](https://docs.astral.sh/uv/guides/package/#__codelineno-10-2)hello_world-1.0.0-py3-none-any.whl
[](https://docs.astral.sh/uv/guides/package/#__codelineno-10-3)hello_world-1.0.0-py3-none-any.whl.publish.attestation
[](https://docs.astral.sh/uv/guides/package/#__codelineno-10-4)hello_world-1.0.0.tar.gz
[](https://docs.astral.sh/uv/guides/package/#__codelineno-10-5)hello_world-1.0.0.tar.gz.publish.attestation
...
```
[](https://docs.astral.sh/uv/guides/package/#__codelineno-11-1)$ uv"import <PACKAGE>"
