...
- Source URL: https://docs.astral.sh/uv/guides/install-python
- Page Title: Installing and managing Python | uv
- Semantic Filename: installing_and_managing_python_uv.md
- Ollama Model: llama3.2:3b
- Export Mode: Smart Deep Crawl
- Statistics:
  - Status: Success
  - Content Length: 5,903 characters
---
...
```
[](https://docs.astral.sh/uv/guides/install-python/#__codelineno-0-1)$ uv
```

Note
Python does not publish official distributable binaries. As such, uv uses distributions from the Astral [Python distributions](https://docs.astral.sh/uv/concepts/python-versions/#managed-python-distributions) documentation for more details.
Once Python is installed, it will be used by `uv` commands automatically. uv also adds the installed version to your `PATH`:
```
[](https://docs.astral.sh/uv/guides/install-python/#__codelineno-1-1)$ python3.13
...
```
[](https://docs.astral.sh/uv/guides/install-python/#__codelineno-2-1)$ uv
```
...
```
[](https://docs.astral.sh/uv/guides/install-python/#__codelineno-3-1)$ uv3.12

```

To install multiple Python versions:
```
[](https://docs.astral.sh/uv/guides/install-python/#__codelineno-4-1)$ uv3.113.12

```

To install an alternative Python implementation, e.g., PyPy:
```
[](https://docs.astral.sh/uv/guides/install-python/#__codelineno-5-1)$ uv
```
...
```
[](https://docs.astral.sh/uv/guides/install-python/#__codelineno-6-1)$ uv
```
...
```
[](https://docs.astral.sh/uv/guides/install-python/#__codelineno-7-1)$ uv
```

See the [`python list`](https://docs.astral.sh/uv/concepts/python-versions/#viewing-available-python-versions) documentation for more details.
...
```
[](https://docs.astral.sh/uv/guides/install-python/#__codelineno-8-1)$ uvx"print('hello world')"
...
```
[](https://docs.astral.sh/uv/guides/install-python/#__codelineno-9-1)$ uv
```
...
uv will use existing Python installations if present on your system. There is no configuration necessary for this behavior: uv will use the system Python if it satisfies the requirements of the command invocation. See the [Python discovery](https://docs.astral.sh/uv/concepts/python-versions/#discovery-of-python-versions) documentation for details.
To force uv to use the system Python, provide the `--no-managed-python` flag. See the [Python version preference](https://docs.astral.sh/uv/concepts/python-versions/#requiring-or-disabling-managed-python-versions) documentation for more details.
## [Upgrading Python versions](https://docs.astral.sh/uv/guides/install-python/#upgrading-python-versions)
Important
Support for upgrading Python patch versions is in _preview_. This means the behavior is experimental and subject to change.
To upgrade a Python version to the latest supported patch release:
```
[](https://docs.astral.sh/uv/guides/install-python/#__codelineno-10-1)$ uv3.12

```

To upgrade all uv-managed Python versions:
```
[](https://docs.astral.sh/uv/guides/install-python/#__codelineno-11-1)$ uv
```
...
To learn more about `uv python`, see the [Python version concept](https://docs.astral.sh/uv/concepts/python-versions/) page and the [command reference](https://docs.astral.sh/uv/reference/cli/#uv-python).
